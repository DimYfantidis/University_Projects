...
subplot(2,2,3),plot(t,x-smooth(x,2051)),hold on,title('trace - very slow component'),xlabel('sample no'),xlim([0,23000])


% detecting the R-peak based on the denoised -trace
x2=x-smooth(x,2051);[PKS,LOCS]=findpeaks(x2,t,'minpeakheight',0.3,'MinPeakDistance',1500);
