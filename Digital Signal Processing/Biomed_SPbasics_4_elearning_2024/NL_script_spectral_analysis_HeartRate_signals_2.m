...
WINDOW=256;NOVERLAP=200;NFFT=256;[pxx,faxis] = pwelch((hr_pre_interpolated-mean(hr_pre_interpolated)),WINDOW,NOVERLAP,NFFT,fs,'onesided'); % Note: detrend is necessary
...
WINDOW=256;NOVERLAP=200;NFFT=256;[pxx,faxis] = pwelch(diff(hr_med_interpolated),WINDOW,NOVERLAP,NFFT,fs,'onesided');
