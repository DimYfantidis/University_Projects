...
class TurtleActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TurtleGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TurtleActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TurtleGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TurtleGoal()
    }
...
module.exports = TurtleActionGoal;
